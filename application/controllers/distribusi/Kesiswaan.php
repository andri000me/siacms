...
class Kesiswaan extends CI_Controller {
	...
	public function index(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin', 'kesiswaan/admin/view_dashboard_admin', $data);
	}
	...
	public function distribusi_reg(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/distribusi_reg', $data);
	}
	...
	public function pilih_pembagian() {
		...
		if ($tipe == "Berdasarkan Agama dan Jenis Kelamin") {
			...
			$data['jenjang'] = $jenjang;			
			$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/pilih_pembagian_prestasi', $data);
		} else {
			$jenjang = $this->input->post('jenjang');
			
			redirect('distribusi/kesiswaan/proses_pembagian_kuartil/'.$jenjang);
		}
	}
	...
	public function pembagian_agama2(){
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/pembagian_agama');
	}
	...
	public function hsl_pembagian_agama(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/hasil_pembagian_agama', $data);	
	}
	...
	public function proses_pembagian_kuartil($jenjang)
	{
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/proses_pembagian_kuartil', $data);	
	}

	public function pembagian_prestasi(){
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/pembagian_prestasi',$data);
	}

	public function hasil_pembagian_prestasi(){
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/hasil_pembagian_prestasi',$data);	
	}
	...
	public function eksportdatakelas($id_kelas_reguler)
	{
		...
		$this->load->view('distribusi/kesiswaan/view_excel_data_kelas', $data);
	}
	...
	public function print_bukti_mutasi_diterima($nisn = "")
	{
		...
		$this->load->view('distribusi/kesiswaan/print_bukti_mutasi_diterima', $data);
	}
	...
	public function distribusi_tam(){
		...
		// $data['kelas_tambahan'] = $data_kelas_tambahan;

		// // $data['jenis_kls_tambahan'] = $this->db->get('jenis_kls_tambahan')->result(); // Dummy
		// $this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/distribusi_tam', $data);
		...
		$data['kelas_tambahan'] = $data_kelas_tambahan;
		$data['kelas_tambahan_master'] = $this->mod_kelas_tambahan->get();
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/distribusi_tam', $data);
	}
	...
	public function tambahkelas_tambahan() {
		...
		$data['foto'] = $this->session->foto;
			...
			$this->form_validation->set_rules('jumlah_kelas_tambahan', 'Jumlah Kelas', 'required');
			$this->form_validation->set_rules('jenjang_kls_tambahan', 'Jenjang', 'required');
			$this->form_validation->set_rules('penamaan', 'Penamaan Kelas', 'required');
			...
			$jumlah_kelas_tambahan = $this->input->post('jumlah_kelas_tambahan');
			$jenjang = $this->input->post('jenjang_kls_tambahan');
			$nama_kelas_tambahan = array();
			for ($i=0;$i<$jumlah_kelas_tambahan;$i++) {
				$nama_kelas_tambahan[$i] = $jenjang.$urutan[$i];
				
				$arrdata = array(
					"nama_kelas_tambahan"=>$nama_kelas_tambahan[$i],
					"jenjang_kls_tambahan"=>$this->input->post('jenjang_kls_tambahan'),
					"kuota_kelas"=>0,
					"jumlah_kelas_tambahan"=>$jumlah_kelas_tambahan,
					
					);
				
				$this->mod_kelas_tambahan->insert($arrdata);
				
			}

			$data['jumlah_kelas_tambahan'] = $jumlah_kelas_tambahan;			
			$data['jenjang_kls_tambahan'] = $jenjang;			
			$data['nama_kelas_tambahan'] = $nama_kelas_tambahan;			
			
			$this->session->set_flashdata('success', 'Kelas Berhasil Dibuat!');
			}
			redirect('distribusi/kesiswaan/distribusi_tam');
	}
	...
	public function pengacakan_tambahan()
	{
		...
		redirect('distribusi/kesiswaan/hasil_pembagian_tambahan');
	}
	...
	public function hasil_pembagian_tambahan(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/hasil_pembagian_tambahan', $data);
	}
	...
	public function klinik_un(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/klinik_un', $data);
	}
	...
	public function hasil_klinik_un() {
		...
		redirect('distribusi/kesiswaan/klinik_un' );
	...
	public function mutasi_masuk(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/mutasi_masuk', $data);
	...
	public function editpendaftar_mutasi(){
		...
		$this->load->view('distribusi/kesiswaan/edit_pendaftar_mutasi', $data);
	...
	public function mutasi_keluar(){
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/mutasi_keluar', $data);
	}
	...
	public function nonaktifkan_akun($nisn)
	{
		...
		redirect('distribusi/kesiswaan/mutasi_keluar');
	...
	public function cetak_bukti_mutasi_keluar($nisn)
	{
		...
		$print = $this->load->view('distribusi/kesiswaan/print_bukti_siswa_mutasi_keluar', $data, TRUE);
	...
	// }
		...
		$this->template->load('kesiswaan/admin/view_template_admin','distribusi/kesiswaan/buku_induk',$data);	
	   }
	   ...
	   public function edit_buku_induk_siswa()
	   {
		...
		$this->load->view('distribusi/kesiswaan/edit_buku_induk_siswa', $data);
	   }
	   ...
	   public function update_buku_induk_siswa()
	   {
		...
		redirect('distribusi/kesiswaan/buku_induk');
	   ...
	   {
	 //   	$this->load->model('distribusi/Mod_orangtua_wali');
		// $data['row_siswa_ortu'] = $this->Mod_orangtua_wali->select($this->uri->segment(4));
	
		// $this->load->view('distribusi/kesiswaan/edit_buku_induk_ortu', $data);
