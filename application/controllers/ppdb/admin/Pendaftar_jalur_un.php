...
class Pendaftar_jalur_un extends CI_Controller {
	...
	public function index()
	{
		...
		$data['tabel_passing_grade'] = $this->model_passing_grade->getpassingtahun();
		...
		$this->template->load('kesiswaan/dashboard', 'kesiswaan/ppdb/admin/view_pendaftar_jalur_un', $data);
	}
	...
	public function saveformnegeri() 
	{
		$this->load->model('ppdb/model_form_ppdb');
		$i=1;
        foreach ($this->db->get('form_ppdb')->result() as $form) 
		...
		redirect('ppdb/admin/pendaftar_jalur_un');
	}
	...
	public function editketentuan()
	{
		...
		$this->load->view('kesiswaan/ppdb/admin/view_edit_ketentuan_negeri', $data);
	}
	...
	public function savepassing() {
		...
		$this->load->model('ppdb/model_passing_grade');
		$this->model_passing_grade->insert($arrdata);
		$this->session->set_flashdata('passing', "<script>alert('Passing Grade berhasil disimpan!');</script>");
		redirect('ppdb/admin/pendaftar_jalur_un');
	}
	...
	public function editnilai()
	{
		...
		$this->load->view('kesiswaan/ppdb/admin/view_lihat_nilai_ppdb_un', $data);
	}
	...
	public function editpendaftar()
	{
		...
		$this->load->view('kesiswaan/ppdb/admin/view_edit_pendaftar_ppdb_negeri', $data);
	}
	...
	public function editpendaftarlolos()
	{
		...
		$this->load->view('kesiswaan/ppdb/admin/view_edit_pendaftar_ppdb_negeri_lolos', $data);
	}
	...
	public function editpengumuman()
	{
		...
		$this->load->view('kesiswaan/admin/view_edit_pengumuman_negeri', $data);
	}
	...
	public function updatepengumuman() 
	{
		...
		$this->session->set_flashdata('pengumuman', "<script>alert('Pengumuman PPDB berhasil diperbarui!');</script>");
	...
	// 		$row_akun = $this->model_akun->selectbynisn($row_pendaftar_ppdb_lolos->nisn_pendaftar);
	// 		if (!$row_akun) {
	// 			$arrdata = array(
	...
	public function eksportujian()
	{
		...
		$this->load->view('kesiswaan/admin/view_excel_ppdb_un', $data);
	}
