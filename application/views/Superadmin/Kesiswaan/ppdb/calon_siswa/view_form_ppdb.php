<section id="feature" class="transparent-bg">
  <div class="container">
      ...
      <?php
          ...
          ?>
          <?php
          if ($settingform['surat_pip'] == '1') {
          ?>
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12"></label>
             <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="checkbox" name="surat_pip" value="1"> 
                Surat Keterangan Program Indonesia Pintar
            </div>
          </div>
          <?php
          }
          ?>
          <?php
          if ($settingform['prestasi_or'] == '1') {
          ?>
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12"></label>
             <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="checkbox" name="prestasi_or" value="1"> 
                Prestasi Olahraga (jika ada)
            </div>
          </div>
          <?php
          }
