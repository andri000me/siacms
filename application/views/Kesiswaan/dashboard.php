...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo base_url();?>kesiswaan" class="logo">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo site_url('kesiswaan/profile');?>"class="btn btn-default btn-flat">Profile</a>
                  </div>
        ...
        <ul class="sidebar-menu">
          ...
          if (in_array("1", $arrmenuakses)) {
            ...
            if (in_array("8", $arrmenuakses)) {
              ?>
              <li><a href="#"><i class="fa fa-circle-o"></i> Penempatan Kelas </a>
                <ul class="treeview-menu">

                  <?php 
                  if (in_array("9", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('kesiswaan/distribusi_reg');?>"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("10", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('kesiswaan/distribusi_tam');?>"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
                    <?php
                  }
                  ?>
                 ...
                 <!--  <?php 
                  if (in_array("11", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>kesiswaan/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
                    <?php
                  }
                  ?> -->
                </ul>
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('kesiswaan/gantipassword');?>">Ganti Password</a></li> 
  </ul> 
</li>
