      ...
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('ppdb/admin/pendaftar_jalur_un/updatependaftar/'.$row_pendaftar_ppdb->nisn_pendaftar); ?>" >
          ...
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12">No Pendaftaran </label>
              <div class="col-md-1 col-sm-1 col-xs-1">
                <input type="text" class="form-control" name="nomor_pendaftaran" required="required" value="<?php echo $row_pendaftar_ppdb->nomor_pendaftaran ?>">
              </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input type="text" id="first-name" required="required" class="form-control" name='no_usbn' value="<?php echo $row_pendaftar_ppdb->no_usbn ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name" required="required" class="form-control col-md-7 col-xs-12" type="text" name="nama" value="<?php echo $row_pendaftar_ppdb->nama ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="agama" value="<?php echo $row_pendaftar_ppdb->agama; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="no_hp_siswa" value="<?php echo $row_pendaftar_ppdb->no_hp_siswa; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12">Waktu Pendaftaran </label>
             ...
             <input name="waktu_pendaftaran" value="<?php echo $row_pendaftar_ppdb->waktu_pendaftaran; ?>" readonly>
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="nama_orang_tua" value="<?php echo $row_pendaftar_ppdb->nama_orang_tua; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="pekerjaan_orang_tua" value="<?php echo $row_pendaftar_ppdb->pekerjaan_orang_tua; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="agama_orang_tua" value="<?php echo $row_pendaftar_ppdb->agama_orang_tua; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <textarea  class="form-control" rows="3" name="alamat_orang_tua"><?php echo $row_pendaftar_ppdb->alamat_orang_tua; ?></textarea>
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="no_telp_orang_tua" value="<?php echo $row_pendaftar_ppdb->no_telp_orang_tua; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="nama_wali" value="<?php echo $row_pendaftar_ppdb->nama_wali; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="pekerjaan_wali" value="<?php echo $row_pendaftar_ppdb->pekerjaan_wali; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <textarea  class="form-control" rows="3" name="alamat_wali"><?php echo $row_pendaftar_ppdb->alamat_wali; ?></textarea>
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="no_telp_wali" value="<?php echo $row_pendaftar_ppdb->no_telp_wali; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12">Asal Sekolah</label>
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" type="text" name="asal_sekolah" value="<?php echo $row_pendaftar_ppdb->asal_sekolah; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <input id="middle-name"  class="form-control col-md-7 col-xs-12" type="text" name="status_sekolah" value="<?php echo $row_pendaftar_ppdb->status_sekolah; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-6 col-xs-3">
              <textarea class="form-control" rows="3" name="alamat_sekolah"><?php echo $row_pendaftar_ppdb->alamat_sekolah; ?></textarea>
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN Bahasa Indonesia </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_ind" value="<?php echo $row_pendaftar_ppdb->nilai_un_ind; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN Matematika </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" class="form-control" required="required" name="nilai_un_mat" value="<?php echo $row_pendaftar_ppdb->nilai_un_mat; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN IPA </label>
              <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_ipa" value="<?php echo $row_pendaftar_ppdb->nilai_un_ipa; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Nilai </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_nun" value="<?php echo $row_pendaftar_ppdb->nilai_un_nun; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Sepak Bola") echo "checked";?>
                      value="Sepak Bola"> Sepak Bola <br>
                <input type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Futsal") echo "checked";?>
                        value="Futsal"> Futsal <br>      
                <input  type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Bola Voly") echo "checked";?>
                        value="Bola Voly"> Bola Voly <br>
                <input type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Renang") echo "checked";?>
                        value="Renang"> Renang <br>
                <input type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Bulu Tangkis") echo "checked";?>
                        value="Bulu Tangkis"> Bulu Tangkis <br>
                <input  type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Basket") echo "checked";?>
                        value="Basket"> Basket <br>
                <input  type="radio" name="minat_olahraga"
                <?php if (isset($row_pendaftar_ppdb->minat_olahraga) && $row_pendaftar_ppdb->minat_olahraga=="Lainnya") echo "checked";?>
