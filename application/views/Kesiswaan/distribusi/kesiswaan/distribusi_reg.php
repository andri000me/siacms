 <div class="content-wrapper">
  ...
  <section class="content-header">
      <h1>
        <center style="color:navy;">Penempatan Kelas Reguler<br></center>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_content6" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Pengaturan Tabel</a>
            </li>
      ...
      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <!-- <a href="<?php echo base_url()?>kesiswaan/isi_siswa_kelas";><button type="button" class="btn btn-round btn-primary">Insert Siswa Kelas </button></a>

            <a class="btn btn-primary" data-toggle="modal" href='#modal-upload-prestasi'>Import Data Prestasi</a> -->
     
            <?php $this->load->view('kesiswaan/distribusi/kesiswaan/modal-upload') ?>

            <form class="form-horizontal form-mapel" method="post" action="<?php echo base_url('kesiswaan/tambahkelas'); ?>">
             ...
             <table class="table table-striped projects_1">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <!-- <a onclick="return confirm"('Apakah anda yakin akan menghapus data? <?php echo $m->id_kelas_reguler; ?>') href="<?php echo site_url("distribusi/kesiswaan/hapus_kelas_reguler/".$m->id_kelas_reguler) ?>" type="button" role="button" class="btn btn-danger">Hapus</a> -->

                            <a onclick="return confirm('Apakah Anda yakin akan menghapus kelas?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('kesiswaan/hapus_kelas_reguler/'.$m->id_kelas_reguler); ?>" > Hapus </a>
                          </td>
                        </tr>
                      <?php
                        }
                   ...
                   <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal form-mapel" method="post" action="<?php echo base_url('kesiswaan/update_kelas_reg'); ?>">
                          <div class="bigbox-mapel">
                             <div class="box-mapel">
                              <div class="form-group formgrup jarakform">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
          <form class="form-horizontal form-mapel" method="post" action="<?php echo base_url('kesiswaan/pilih_pembagian'); ?>">
            <div class="bigbox-mapel">
              <div class="box-mapel">
                <a href="<?php echo base_url()?>kesiswaan/buat_kelas_reguler_berjalan";><button type="button" class="btn btn-round btn-primary">Aktifkan Kelas </button></a>
                <div class="form-group">
            ...
            <table class="table table-striped projects">
                      ...
                      <?php
                        ...
                        foreach ($kelas_reguler as $m) {
                          $i++;
                      ?>
                      <form action="<?= base_url() ?>kesiswaan/simpan_walikelas" method="post">
                        <tr>
                          <td><?php //echo $i; ?></td>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $m->nama_kelas; ?></td>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a type="button" role="button" href=<?php echo site_url('kesiswaan/eksportdatakelas/'.$m->id_kelas_reguler);?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Kelas</a>
          ...
          <div role="tabpanel" class="tab-pane fade" id="tab_content6" aria-labelledby="profile-tab">
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/savetabel'); ?>">  
                <div class="form-group">
                  
                  <h4 class="box-title"><center><b>Pengaturan Tabel Penempatan Siswa</b></center></h4>    
                    <p><center>Berikan centang pada atribut tabel yang ingin dikeluarkan sebagai Tabel Penempatan Siswa </p></center>  
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      <?php
                      $i=1;
                      foreach ($tabel_pengaturan_kelas_reg as $tabel) 
                      { 
                        if ($i < 8) 
                        {
                          ?><input type="checkbox" class="flat" name="nilai<?php echo $tabel->id_pengaturan_kelas_reg; ?>" value="1" <?php 
                          if ($tabel->nilai == "1") 
                            { echo " checked"; } ?>>
                      ...
                      <div class="modal-footer" align="center">
                        ...
                        <button type="Save" class="btn btn-success" onclick="return cek();">Aktifkan Tabel</button>
                      </div>
                    </div>
                  </div>
                </form>
