    ...
    <ul class="treeview-menu">
      ...
      if (in_array("46", $arrmenuakses)) {
        ...
        if (in_array("50", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo base_url();?>konseling/prestasi"><i class="fa fa-circle-o text-red"></i> Penghargaan</a></li>
          <?php 
        }
        ?>
        ...
        if (in_array("47", $arrmenuakses)) {
          ?>
          <li ><a href="<?php echo base_url();?>konseling/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan</a></li>
          <?php 
        }
        ?>
