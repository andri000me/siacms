<div class="content-wrapper">
 ...
 <?php echo $this->session->flashdata('warning')?>
              <div class="tab-pane" id="gantipassword">
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('konseling/updatepassword'); ?>">
                  ...
                  <div class="box-mapel" style="padding: 2% 0">
                      ...
                      <button type="submit" role="button" class="btn btn-primary">Ganti Password</button>
                         <a href="<?php echo site_url('konseling/gantipassword');?>" type="button" role="button" class="btn btn-primary">Cancel</a>
