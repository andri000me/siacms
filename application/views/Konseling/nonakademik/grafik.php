            ...
            <section class="col-lg-12 ">
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs pull-left">
                        <li><a href="<?php echo site_url('konseling/keterlambatan'); ?>">Keterlambatan Siswa</a></li>
                        <li class="active">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <select id="thn" name="tahun"
                                onchange="document.location = '<?php echo site_url('konseling/grafik'); ?>/'+document.getElementById('thn').value;">
