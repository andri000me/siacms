		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Data Keterlambatan Siswa SMP</h4>
				</div>
						...
						foreach ($keterlambatan as $row) : 
							...
							<tr>
								...
								if ($proses != $row->nisn) {
									...
									if ($jumlah>=3) {
									?>
									<td rowspan="<?php echo $rowspan; ?>"><a target="_blank" href="<?php echo site_url('nonakademik/suratperingatan/'.$id_keterlambatan); ?>">Print</a>
									</td>
									<?php
									}
									?>
