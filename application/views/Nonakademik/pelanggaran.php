...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <center><small>Pelanggaran Siswa yang didapat selama berada di dalam sekolahhhh</small></center>
      </h1>
      <ol class="breadcrumb">
         ...
         <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <form role="form" method="post" action="<?php echo site_url('nonakademik/simpanpelanggaran'); ?>">
                  <?php
                      $tgl = date('Y-m-d');
                ...
                <div class="box">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td><a href="<?php echo site_url('nonakademik/deletepelanggaran/'.$rowpelanggaran->id_jenis_pelanggaran); ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin?');">Del</a></td>
                            <?php
                            }
                            ?>
                          </table>
